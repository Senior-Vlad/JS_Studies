...
class CustomArray extends Array {
  customPush(newElement) {
    //push(newElement){...} just overrides the .push method
    this[this.length] = newElement;
    console.log(`New element ${newElement} has just been added to the array`);
  }
}
const newArray1 = new CustomArray(1, 2, 5, "hello", undefined, "bro");
console.log(newArray1);
newArray1.customPush(21);
console.log(newArray1);
newArray1.push(42);
console.log(newArray1);

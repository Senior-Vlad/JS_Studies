...
const isElementInArray = (searchElement, inputArray) => {
  ...
  return inputArray.map(JSON.stringify).includes(JSON.stringify(searchElement));
  // const stringInput = inputArray.map(JSON.stringify);
  // // console.log(stringInput);
  // const stringSearch = JSON.stringify(searchElement);
  // // console.log(stringSearch);
  // return stringInput.includes(stringSearch);
};
